...
#  Resource of an external file
#
#  This resource keeps several methods pure virtual so it can
#  be used only in very specific environment (it's designated
#  to be used for linked libraries)
package SBuild::ExtResource;
