...
# A record of the install logger
package SBuild::InstallLoggerRecord;
...
sub makeLogRecord {
	die "Pure virtual method: InstallLoggerRecord::makeLogRecord";
}
...
sub cleanInstalledFiles {
	die "Pure virtual method: InstallLoggerRecord::cleanInstalledFiles"
}
