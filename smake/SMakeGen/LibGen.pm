...
#  Generator of library project
package SMakeGen::LibGen;
...
use SMakeGen::LibDirectiveGen;

#  Ctor
#
#  Usage: newProjectGen($prjname, $libname)
sub newProjectGen {
	my $class = $_[0];
...
sub createDirectives {
	...
	push @list, SMakeGen::LibDirectiveGen->newDirectiveGen($this->{libname});
