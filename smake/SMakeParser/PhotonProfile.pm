...
#  Photon compilation profile
package SMakeParser::PhotonProfile;
...
sub newCompileProfile {
	my $class = shift;
	my $this = SBuild::CompileProfile->newCompileProfile("photon");
	bless $this, $class;
}
...
sub changeProject {
	...
	$assembler->addSysLink(["photon", "phexlib3r", "Aplib3r"]);
}
