...
#  Ctor
#
#  Usage: newTask($name, $resource, \@dir_list)
sub newTask {
	my $class = shift;
...
sub getCommand {
	...
	my $dirlist = $this->convertToDirList($profile, $this->{clean_list});
	my $command = $profile->getToolChain->getClean($dirlist, "-R");
}
