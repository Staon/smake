...
#  Generate RPC stub and skeleton
package SBuild::RPCTask;
...
sub getTaskCommand {
	...
	return "rpcgen $options " . $sources->[0]->getFullname($profile);
}
...
sub getOptions {
	my $profile = $_[1];
	my $reporter = $_[2];
	return $profile->getProfileStack->getOptions("RPCFLAGS", $profile, $reporter);
}
